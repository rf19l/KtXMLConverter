...
class RawXmlParserTest {
    ...
    fun `parseXml string`() {
        ...
        val largeFontSizeDimenResource = dimens.find { it is DimenXmlResource && it.name == "font_size_large" } as DimenXmlResource
        val textColorPrimaryResource = colors.find { it is ColorXmlResource && it.name == "textColorPrimary" } as ColorXmlResource
